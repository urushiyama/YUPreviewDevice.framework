...
public extension PreviewDevice {
  ...
  struct Product: Identifiable {
    ...
    static let mac = Product(name: "Mac")
    
    static let iPhone_7 = Product(name: "iPhone 7")
    static let iPhone_7_Plus = Product(name: "iPhone 7 Plus")
    static let iPhone_8 = Product(name: "iPhone 8")
    static let iPhone_8_Plus = Product(name: "iPhone 8 Plus")
    static let iPhone_SE = Product(name: "iPhone SE")
    static let iPhone_X = Product(name: "iPhone X")
    static let iPhone_Xs = Product(name: "iPhone Xs")
    static let iPhone_Xs_Max = Product(name: "iPhone Xs Max")
    static let iPhone_Xʀ = Product(name: "iPhone Xʀ")
    static let iPhone_11 = Product(name: "iPhone 11")
    static let iPhone_11_Pro = Product(name: "iPhone 11 Pro")
    static let iPhone_11_Pro_Max = Product(name: "iPhone 11 Pro Max")
    
    static let iPad_Mini_4 = Product(name: "iPad mini 4")
    static let iPad_Air_2 = Product(name: "iPad Air 2")
    static let iPad_Pro_9_7Inch = Product(name: "iPad Pro (9.7-inch)")
    static let iPad_Pro_12_9Inch = Product(name: "iPad Pro (12.9-inch)")
    static let iPad_5thGeneration = Product(name: "iPad (5th generation)")
    static let iPad_Pro_12_9Inch_2ndGeneration = Product(name: "iPad Pro (12.9-inch) (2nd generation)")
    static let iPad_Pro_10_5Inch = Product(name: "iPad Pro (10.5-inch)")
    static let iPad_6thGeneration = Product(name: "iPad (6th generation)")
    static let iPad_Pro_11Inch = Product(name: "iPad Pro (11-inch)")
    static let iPad_Pro_12_9Inch_3rdGeneration = Product(name: "iPad Pro (12.9-inch) (3rd generation)")
    static let iPad_Mini_5thGeneration = Product(name: "iPad mini (5th generation)")
    static let iPad_Air_3rdGeneration = Product(name: "iPad Air (3rd generation)")
    static let iPad_7thGeneration = Product(name: "iPad (7th generation)")
    
    static let apple_TV = Product(name: "Apple TV")
    static let apple_TV_4K = Product(name: "Apple TV 4K")
    static let apple_TV_4K_At1080p = Product(name: "Apple TV 4K (at 1080p)")
    
    static let apple_Watch_Series2_38mm = Product(name: "Apple Watch Series 2 - 38mm")
    static let apple_Watch_Series2_42mm = Product(name: "Apple Watch Series 2 - 42mm")
    static let apple_Watch_Series3_38mm = Product(name: "Apple Watch Series 3 - 38mm")
    static let apple_Watch_Series3_42mm = Product(name: "Apple Watch Series 3 - 42mm")
    static let apple_Watch_Series4_40mm = Product(name: "Apple Watch Series 4 - 40mm")
    static let apple_Watch_Series4_44mm = Product(name: "Apple Watch Series 4 - 44mm")
    ...
    static let latest_iPhones_with_different_ratio = [
    ...
    static let latest_iPads_with_different_ratio = [
    ...
    static let latest_apple_Watches = [
      Self.apple_Watch_Series4_40mm, Self.apple_Watch_Series4_44mm
    ]
  ...
  struct Model: Identifiable {
    ...
    // iPhone 7
    static let iPhone_9_1 = Model(id: "iPhone9,1")
    static let iPhone_9_3 = Model(id: "iPhone9,3")
    
    // iPhone 7 Plus
    static let iPhone_9_2 = Model(id: "iPhone9,2")
    static let iPhone_9_4 = Model(id: "iPhone9,4")
    
    // iPhone SE
    static let iPhone_8_4 = Model(id: "iPhone8,4")
    
    // iPhone 8
    static let iPhone_10_1 = Model(id: "iPhone10,1")
    static let iPhone_10_4 = Model(id: "iPhone10,4")
    
    // iPhone 8 Plus
    static let iPhone_10_2 = Model(id: "iPhone10,2")
    static let iPhone_10_5 = Model(id: "iPhone10,5")
    
    // iPhone X
    static let iPhone_10_3 = Model(id: "iPhone10,3")
    static let iPhone_10_6 = Model(id: "iPhone10,6")
    
    // iPhone Xʀ
    static let iPhone_11_8 = Model(id: "iPhone11,8")
    
    // iPhone Xs
    static let iPhone_11_2 = Model(id: "iPhone11,2")
    
    // iPhone Xs Max
    static let iPhone_11_6 = Model(id: "iPhone11,6")
    static let iPhone_11_4 = Model(id: "iPhone11,4")
    
    // iPhone 11
    static let iPhone_12_1 = Model(id: "iPhone12,1")
    
    // iPhone 11 Pro
    static let iPhone_12_3 = Model(id: "iPhone12,3")
    
    // iPhone 11 Pro Max
    static let iPhone_12_5 = Model(id: "iPhone12,5")
    
    // iPad (6th generation)
    static let iPad_7_5 = Model(id: "iPad7,5")
    static let iPad_7_6 = Model(id: "iPad7,6")
    
    // iPad (7th generation)
    static let iPad_7_11 = Model(id: "iPad7,11")
    static let iPad_7_12 = Model(id: "iPad7,12")
    
    // iPad Air 2
    static let iPad_5_3 = Model(id: "iPad5,3")
    static let iPad_5_4 = Model(id: "iPad5,4")
    
    // iPad Air (3rd generation)
    static let iPad_11_3 = Model(id: "iPad11,3")
    static let iPad_11_4 = Model(id: "iPad11,4")
    
    // iPad Pro (12.9-inch)
    static let iPad_6_7 = Model(id: "iPad6,7")
    static let iPad_6_8 = Model(id: "iPad6,8")
    
    // iPad Pro (9.7-inch)
    static let iPad_6_3 = Model(id: "iPad6,3")
    static let iPad_6_4 = Model(id: "iPad6,4")
    
    // iPad Pro (12.9-inch) (2nd generation)
    static let iPad_7_1 = Model(id: "iPad7,1")
    static let iPad_7_2 = Model(id: "iPad7,2")
    
    // iPad Pro (10.5-inch)
    static let iPad_7_3 = Model(id: "iPad7,3")
    static let iPad_7_4 = Model(id: "iPad7,4")
    
    // iPad Pro (11-inch)
    static let iPad_8_1 = Model(id: "iPad8,1")
    static let iPad_8_2 = Model(id: "iPad8,2")
    static let iPad_8_3 = Model(id: "iPad8,3")
    static let iPad_8_4 = Model(id: "iPad8,4")
    
    // iPad Pro (12.9-inch) (3rd generation)
    static let iPad_8_5 = Model(id: "iPad8,5")
    static let iPad_8_6 = Model(id: "iPad8,6")
    static let iPad_8_7 = Model(id: "iPad8,7")
    static let iPad_8_8 = Model(id: "iPad8,8")
    
    // iPad Mini 4
    static let iPad_5_1 = Model(id: "iPad5,1")
    static let iPad_5_2 = Model(id: "iPad5,2")
    
    // iPad Mini (5th generation)
    static let iPad_11_1 = Model(id: "iPad11,1")
    static let iPad_11_2 = Model(id: "iPad11,2")
    
    // Apple TV
    static let apple_TV_5_3 = Model(id: "AppleTV5,3")
    // Apple TV 4k (at 1080p)
    static let apple_TV_6_2 = Model(id: "AppleTV6,2")
    
    // Apple Watch Series 2
    static let apple_Watch_2_3 = Model(id: "Watch2,3")
    static let apple_Watch_2_4 = Model(id: "Watch2,4")
    
    // Apple Watch Series 3
    static let apple_Watch_3_1 = Model(id: "Watch3,1")
    static let apple_Watch_3_2 = Model(id: "Watch3,2")
    static let apple_Watch_3_3 = Model(id: "Watch3,3")
    static let apple_Watch_3_4 = Model(id: "Watch3,4")
    
    // Apple Watch Series 4
    static let apple_Watch_4_1 = Model(id: "Watch4,1")
    static let apple_Watch_4_2 = Model(id: "Watch4,2")
    static let apple_Watch_4_3 = Model(id: "Watch4,3")
    static let apple_Watch_4_4 = Model(id: "Watch4,4")
  }
